drop function public.search_businesses(text, text);
...
comment on function public.search_businesses(text, text, boolean) is
  'Busca negocios por relevancia, categoría y horario vigente en Bogotá.';

revoke all on function public.search_businesses(text, text, boolean)
from public;
